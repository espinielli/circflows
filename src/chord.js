...
(function( scope ) {
  ...
  scope.chord = function() {
    ...
    function subgroup( self, f, d, i, target ) {
      var sg = f.call( self, d, i ),
          r = radius.call( self, sg, i ),
          a0 = startAngle.call( self, sg, i ) + d3_svg_arcOffset,
          a1 = endAngle.call( self, sg, i ) + d3_svg_arcOffset,
          p;

      if ( target ) {
        p = targetPadding.call( self, sg, i ) || 0;
      } else {
        p = sourcePadding.call( self, sg, i ) || 0;
      }
      r = r - p;
